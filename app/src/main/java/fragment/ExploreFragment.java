...
/**
 * Created by shashank on 6/22/2017.
 */
...
public class ExploreFragment extends Fragment {
    private static final String LIST_STATE_KEY = "savelist";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null)
            Log.v("CHECKLIST","STATERESTOREDINFRAGMENT");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.v(TAG,"HOME ON CREATEVIEW CALLED");
    ...
    {
        progressBar.setVisibility(View.VISIBLE);
        String url = "http://writm.com/get_post.php/?a=" + String.valueOf(start_index)+"&b="+ String.valueOf(end_index) +"&user_id="+new Preference(getActivity()).getUserid();
